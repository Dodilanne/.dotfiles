...
alt + shift + ctrl - r : open -a "hodei"
alt + shift + ctrl - s : open -a "Discord"
alt + shift + ctrl - t : open -a "Ghostty"
alt + shift + ctrl - g : open -a "GitUp"

alt + shift + ctrl - z : open -a "Messages"
alt + shift + ctrl - x : open -a "Google Chrome"
...
alt + shift + ctrl - n : open -a "Xournal++"
