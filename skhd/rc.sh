...
alt + shift + ctrl - r : open -a "hodei"; obsws-cli scene switch Hodei
...
# alt + shift + ctrl - i : open -a ""
alt + shift + ctrl - o : open -a "OBS"

alt + shift + ctrl - z : open -a "Messages"
alt + shift + ctrl - x : open -a "Safari"
alt + shift + ctrl - c : open -a "Google Chrome"; obsws-cli scene switch Chrome
alt + shift + ctrl - d : open -a "DataGrip"; obsws-cli scene switch DataGrip
# alt + shift + ctrl - v : open -a ""
